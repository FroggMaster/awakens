...
module.exports = {
    ...
    names : [ "Amara", "Anon2000", "Anonymous", "aoeu", "AtLeastK", "bartification", "Bjork", "Bruno02468", "citizen69", "DoosmdayMuffinz", "existence", "gaybutts", "get52", "gourami", "GrosslyIncandesentSunBro", "HugeWanker", "InfraRaven", "jezebel", "Kevin", "KrezeyGuy", "KrYnoMoRe", "Liam", "lulu", "Mishashule", "Mr.Guy", "Ookami", "Sammich", "SickNick", "Spoki", "Thefireball", "Xultra", "Dan_The_man", "Itsa_me_mario", "laal", "Kremurge", "SpartanMJO12", "AT NITE", "babbysitter", "buttercup", "ChizLiza", "CogitoProxy", "Donut", "Dougle", "FloralGhostly", "Hatehertodeath", "HydraulicHacker", "Lolijuice", "Poopman", "RandomGuy_", "Skyler", "steven", "StormBeatz", "tacokittyswag", "turtle", "Vile", "yolo360swagscope" ]
};
