...
parser = {
    ...
    parse : function(str) {
        ...
        str = str.replace(/&gt;&gt;&gt;(\/[a-z0-9]+)\/(\d+)?\/?/gi, ' <a target="_blank" href="https://8ch.net$1/res/$2.html">$&</a>');
        ...
        //original = ['The Western culture','is one of decadence','and immorality.','America in particular insists','on dragging the rest of','the world down with it','into the fires of hell. ','the world needs','Islam more than ever.','The caliphate that is now ','growing ever stronger will','I, a dedicated jihadi','and follower of what you perceive to be "radical"','Islam have seen firsthand','the ineffectiveness of President Obama','Even now, plans are in motion','to strike at the very heart of your crumbling society.','We are in your streets and hometowns; ','we are all over the world. The',' Islamic revolution is only now beginning, ','and when it comes to your home you will regret having not ','repented your many sins.',' you today: not to threaten you,',' but to offer salvation. You must accept Allah',' into your spirit and be prepared to fight ','in his divine name to your last breath. I will not pretend that this is your only ','warning. For most of you, there will be many chances as you see fellow infidels die for their blasphemy.But know that if you continue to impede the spread of the one true faith, our knives will continue to hack at the necks of ','your people. We will never stop, for while you fear death, we seek only to die in Allah','Allahu Akbar']
