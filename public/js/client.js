...
// Theme
// ------------------------------------------------------------------
var listOfColors = {"aliceblue":"#f0f8ff","antiquewhite":"#faebd7","aqua":"#00ffff","aquamarine":"#7fffd4",
...
$(function() {
    ...
    function lighten(color) {
    	...
    	if (color.length < 6){
    		return 
    		(255 - (( 255 - parseInt(color.substr(1,1), 16) ) / 1.5)).toString(16) +  
    		(255 - (( 255 - parseInt(color.substr(2,1), 16) ) / 1.5)).toString(16) +
    		(255 - (( 255 - parseInt(color.substr(3,1), 16) ) / 1.5)).toString(16);
    	}
    	else {
    		return 
    		255 - (( 255 - parseInt(color.substr(1,2), 16) ) / 1.5).toString(16) + 
    		255 - (( 255 - parseInt(color.substr(3,2), 16) ) / 1.5).toString(16) +
    		255 - (( 255 - parseInt(color.substr(5,2), 16) ) / 1.5).toString(16);
    ...
    CLIENT.on('change:chat_style', function(m, style){
        ...
        $('#tabbed-menu').css('background-color', lighten(style[0]));
